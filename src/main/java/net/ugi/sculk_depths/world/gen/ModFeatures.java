...
public class ModFeatures {
    ...
    public static final Feature<DefaultFeatureConfig> SCULK_VEINS = new SculkVeins(DefaultFeatureConfig.CODEC);
    ...
    public static void init(){
        ...
        Registry.register(Registries.FEATURE, SculkDepths.identifier("sculk_veins"), SCULK_VEINS );
