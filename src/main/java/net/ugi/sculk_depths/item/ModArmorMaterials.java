...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    // mod armor
    CUSTOMARMORMATERIAL("customarmormaterial", 37, new int[]{3, 6, 8, 3}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{ModItems.SOUL_HEART});
    });
