...
public class ModBlocks {
    ...
    public static final Block FLUMROCK = registerBlock("flumrock",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(4.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block CRUMBLING_DIRT = registerBlock("crumbling_dirt",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(1.0f).requiresTool().sounds(BlockSoundGroup.ROOTED_DIRT)), ModItemGroup.SCULK_DEPTHS);

    public static final Block KRYSLUM_ENRICHED_SOIL = registerBlock("kryslum_enriched_soil",
            new KryslumEnrichedSoilBLock(FabricBlockSettings.of(Material.SOIL).ticksRandomly().strength(0.6f).sounds(BlockSoundGroup.GRAVEL)), ModItemGroup.SCULK_DEPTHS);


    //umbrusk blockset
    public static final Block UMBRUSK = registerBlock("umbrusk",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).hardness(5.0f).resistance(8f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block UMBRUSK_STAIRS = registerBlock("umbrusk_stairs",
            new StairsBlock(UMBRUSK.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(5.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block UMBRUSK_SLAB = registerBlock("umbrusk_slab",
            new SlabBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(5.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block UMBRUSK_WALL = registerBlock("umbrusk_wall",
            new WallBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(5.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);


    //umbrusk brick blockset
    public static final Block UMBRUSK_BRICKS = registerBlock("umbrusk_bricks",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(5.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block VALTROX_LOG = registerBlock("valtrox_log",
            new PillarBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.0f)), ModItemGroup.SCULK_DEPTHS);

    public static final Block VALTROX_PLANKS = registerBlock("valtrox_planks",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.0f)), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block VALTROX_SLAB = registerBlock("valtrox_slab",
            new SlabBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.0f)), ModItemGroup.SCULK_DEPTHS);

    public static final Block VALTROX_STAIRS = registerBlock("valtrox_stairs",
            new StairsBlock(VALTROX_PLANKS.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(5.0f)), ModItemGroup.SCULK_DEPTHS);

    public static final Block VALTROX_FENCE = registerBlock("valtrox_fence",
            new FenceBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.0f)), ModItemGroup.SCULK_DEPTHS);

    //dried valtrox blockset
    public static final Block DRIED_VALTROX_LOG = registerBlock("dried_valtrox_log",
            new PillarBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.5f)), ModItemGroup.SCULK_DEPTHS);

    public static final Block DRIED_VALTROX_PLANKS = registerBlock("dried_valtrox_planks",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.5f)), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block DRIED_VALTROX_SLAB = registerBlock("dried_valtrox_slab",
            new SlabBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.5f)), ModItemGroup.SCULK_DEPTHS);

    public static final Block DRIED_VALTROX_STAIRS = registerBlock("dried_valtrox_stairs",
            new StairsBlock(DRIED_VALTROX_PLANKS.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.5f)), ModItemGroup.SCULK_DEPTHS);

    public static final Block DRIED_VALTROX_FENCE = registerBlock("dried_valtrox_fence",
            new FenceBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(2.5f)), ModItemGroup.SCULK_DEPTHS);


    //petrified valtrox blockset
    public static final Block PETRIFIED_VALTROX_LOG = registerBlock("petrified_valtrox_log",
            new PillarBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(3.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block PETRIFIED_VALTROX_SLATES = registerBlock("petrified_valtrox_slates",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(3.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block PETRIFIED_VALTROX_SLAB = registerBlock("petrified_valtrox_slab",
            new SlabBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(3.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block PETRIFIED_VALTROX_STAIRS = registerBlock("petrified_valtrox_stairs",
            new StairsBlock(PETRIFIED_VALTROX_SLATES.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(3.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block PETRIFIED_VALTROX_WALL = registerBlock("petrified_valtrox_wall",
            new WallBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(3.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block ZYGRIN_STAIRS = registerBlock("zygrin_stairs",
            new StairsBlock(ZYGRIN.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(4.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block ZYGRIN_WALL = registerBlock("zygrin_wall",
            new WallBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(4.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);

    public static final Block ZYGRIN_PILLAR = registerBlock("zygrin_pillar",
            new PillarBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(4.0f)), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block POLISHED_ZYGRIN_STAIRS = registerBlock("polished_zygrin_stairs",
            new StairsBlock(POLISHED_ZYGRIN.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(4.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block ZYGRIN_BRICK_STAIRS = registerBlock("zygrin_brick_stairs",
            new StairsBlock(ZYGRIN_BRICKS.getDefaultState(), AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).strength(4.0f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
    ...
    public static final Block QUAZARITH_ORE = registerBlock("quazarith_ore",
            new Block(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.BLOCK).hardness(6.0f).resistance(10f).requiresTool()), ModItemGroup.SCULK_DEPTHS);
