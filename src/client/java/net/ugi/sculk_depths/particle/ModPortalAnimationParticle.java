...
public class ModPortalAnimationParticle
    ...
    public static class Factory
        ...
        public Particle createParticle(SimpleParticleType parameters, ClientWorld clientWorld, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            ...
            ModPortalParticle particle = new ModPortalParticle(clientWorld, x, y, z, 0.1f, 0.1f, 0.1f, velocityX, velocityY, velocityZ, 0.18f, this.spriteProvider, 1f, 1, -0.003f, false);
            particle.setColor(1,1,1);
            particle.setMaxAge(MathHelper.nextBetween(clientWorld.random, 1, 60));
