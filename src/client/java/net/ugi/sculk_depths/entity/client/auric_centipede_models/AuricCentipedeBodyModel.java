...
public class AuricCentipedeBodyModel<T extends AuricCentipedeEntity> extends SinglePartEntityModel<T> {


	private final ModelPart auric_centipede_body;

	public AuricCentipedeBodyModel(ModelPart root) {
		this.auric_centipede_body = root.getChild("auric_centipede_body");
	}
...
//		this.updateAnimation(entity.idleAnimationState, ModAnimations.GLOMPER_IDLE, ageInTicks, 1f);
	...
	public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int light, int overlay, int color) {
		auric_centipede_body.render(matrices, vertexConsumer, light, overlay, color);
	}

	@Override
	public ModelPart getPart() {
		return auric_centipede_body;
	}
}