...
//TODO
    ...
    //auric //TODO check blocksettings
      ...
      public static final Block AURIC_VINES = registerBlockWithoutBlockItem("auric_vines",
            new Auric_VinesBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.DESTROY).ticksRandomly().noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES_LOW_PITCH)), ModItemGroup.SCULK_DEPTHS);
    public static final Block AURIC_VINES_END = registerBlock("auric_vines_end",
            new Auric_Vines_EndBlock(AbstractBlock.Settings.create().pistonBehavior(PistonBehavior.DESTROY).ticksRandomly().noCollision().breakInstantly().sounds(BlockSoundGroup.WEEPING_VINES_LOW_PITCH)), ModItemGroup.SCULK_DEPTHS);
