...
public class ModRecipes {
    public static void register() {
        Registry.register(Registries.RECIPE_SERIALIZER, new Identifier(SculkDepths.MOD_ID, FlumrockCauldronRecipeSerializer.ID),
                FlumrockCauldronRecipeSerializer.INSTANCE);
