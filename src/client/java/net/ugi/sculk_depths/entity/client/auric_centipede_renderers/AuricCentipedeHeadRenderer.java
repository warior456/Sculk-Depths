...
public class AuricCentipedeHeadRenderer extends MobEntityRenderer<AuricCentipedeEntity, AuricCentipedeHeadModel<AuricCentipedeEntity>> {
    ...
    public AuricCentipedeHeadRenderer(EntityRendererFactory.Context context) {
