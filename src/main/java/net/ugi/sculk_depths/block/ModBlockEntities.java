...
public class ModBlockEntities {
    ...
    public static BlockEntityType<FurnaceBlockEntity> ZYGRIN_FURNACE_BLOCK_ENTITY;
...
/*        FLUMROCK_CAULDRON_BLOCK_ENTITY = Registry.register(
        ...
        ZYGRIN_FURNACE_BLOCK_ENTITY = Registry.register(
                Registries.BLOCK_ENTITY_TYPE,
                new Identifier(SculkDepths.MOD_ID, "flumrock_cauldron_block_entity"),
                FabricBlockEntityTypeBuilder.create(FurnaceBlockEntity::new, ModBlocks.ZYGRIN_FURNACE).build());//todo change to our own blockentity if needed
