...
public class AbstractZygrinFurnaceScreen<T extends AbstractZygrinFurnaceScreenHandler> extends HandledScreen<T> implements RecipeBookProvider {
    ...
    public AbstractZygrinFurnaceScreen(
            T handler,
