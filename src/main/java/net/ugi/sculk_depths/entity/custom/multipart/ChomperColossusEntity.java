...
public class ChomperColossusEntity extends PathAwareEntity {
    ...
    private final ChomperColossusPart[] parts;
    public final ChomperColossusPart head;
    private final ChomperColossusPart body;
    ...
    public ChomperColossusEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
        ...
        this.body = new ChomperColossusPart(this, "body", 5.0f, 5.0f);
        this.head = new ChomperColossusPart(this, "head", 3.0f, 3.0f);
        this.parts = new ChomperColossusPart[]{this.head,  this.body, };
    ...
    public void tick() {
        ...
        this.movePart(this.body, 0, 0.0, 0 );
        this.movePart(this.head, 0, 0.0, 0 );
    }

    private void movePart(ChomperColossusPart chomperColossusPart, double dx, double dy, double dz) {
        chomperColossusPart.setPosition(this.getX() + dx, this.getY() + dy, this.getZ() + dz);
    }
...
//todo what does this
    ...
    public boolean damagePart(ChomperColossusPart part, DamageSource source, float amount) {
        if (part != this.head) {
    ...
    public ChomperColossusPart[] getBodyParts() {
        return this.parts;
    }
...
/*    @Override
    ...
    public void onSpawnPacket(EntitySpawnS2CPacket packet) {
        ...
        ChomperColossusPart[] multipartEntityParts = this.getBodyParts();
        for (int i = 0; i < multipartEntityParts.length; ++i) {
            multipartEntityParts[i].setId(i + packet.getId());
        }
    }
